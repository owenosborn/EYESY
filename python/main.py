...
# set res from command line
try:
    etc.xres = int(sys.argv[1])
    etc.yres = int(sys.argv[2])
except:
    print "no res defined, using default"
...
ch = 1
try :
    file = open(etc.USER_DIR + "/MIDI-Channel.txt", "r")
    line = file.readline()
    ch = int(line.strip())
