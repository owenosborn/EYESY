...
class System:
    ...
    USER_DIR = "/sdcard"
    GRABS_PATH = USER_DIR + "/Grabs/"
    MODES_PATH = USER_DIR + "/Modes/"
    SCENES_PATH = USER_DIR + "/Scenes.csv"
    ...
    def load_grabs(self):
        ...
        self.lastgrab = pygame.Surface((self.xres, self.yres) )
